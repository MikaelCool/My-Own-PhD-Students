...
CONTRACTS: dict[Stage, StageContract] = {
    ...
    Stage.TOPIC_INIT: StageContract(
        ...
        input_files=(),
        output_files=("goal.md", "goal_brief.md", "hardware_profile.json"),
    ...
    Stage.PROBLEM_DECOMPOSE: StageContract(
        ...
        input_files=("goal.md", "goal_brief.md"),
        output_files=("problem_tree.md", "problem_tree_brief.md", "problem_anchor.md", "problem_anchor_brief.md"),
    ...
    Stage.SEARCH_STRATEGY: StageContract(
        ...
        input_files=("problem_tree.md", "problem_tree_brief.md", "problem_anchor.md", "problem_anchor_brief.md"),
        output_files=("search_plan.yaml", "sources.json", "queries.json", "search_strategy_brief.md", "scoping_handoff.md"),
    ...
    Stage.LITERATURE_COLLECT: StageContract(
        ...
        input_files=("search_plan.yaml", "search_strategy_brief.md"),
