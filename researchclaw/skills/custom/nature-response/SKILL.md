...
metadata:
  category: writing
  trigger-keywords: "reviewer response,response letter,rebuttal,revision,major revision,minor revision,peer review,reviewer comments,editor decision,审稿意见回复,逐点回复,修回信,大修回复,小修回复"
  applicable-stages: "18,19,20"
  priority: "1"
  version: "0.1.0-researchclaw-dc2236c"
  author: "Yuan1z0825/nature-skills"
  references: "https://github.com/Yuan1z0825/nature-skills/tree/main/skills/nature-response"
  preconditions: "Use when reviewer/editor comments or review-risk findings are available"
  expected-gain: "Traceable reviewer response strategy and safer revision wording"
