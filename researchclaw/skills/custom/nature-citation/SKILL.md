...
metadata:
  category: writing
  trigger-keywords: "citation,citations,reference,references,bibliography,EndNote,RIS,Zotero,Nature,CNS,Cell,Science,支撑文献,补引用,找引用,自动给出引用,分段引用"
  applicable-stages: "16,17,19,20,22,23"
  priority: "1"
  version: "dc2236c-researchclaw"
  author: "Yuan1z0825/nature-skills"
  references: "https://github.com/Yuan1z0825/nature-skills/tree/main/skills/nature-citation"
  preconditions: "Use after claims are stable enough to map to supporting literature; Do not invent citation support"
  expected-gain: "Stricter claim-to-citation support and reference-manager-ready exports"
