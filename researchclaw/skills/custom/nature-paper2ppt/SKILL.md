...
metadata:
  category: writing
  trigger-keywords: "ppt,pptx,slides,presentation,journal club,group meeting,paper sharing,seminar,汇报,PPT,幻灯片,组会,论文分享"
  applicable-stages: "21,22"
  priority: "4"
  version: "dc2236c-researchclaw"
  author: "Yuan1z0825/nature-skills"
  references: "https://github.com/Yuan1z0825/nature-skills/tree/main/skills/nature-paper2ppt"
  preconditions: "Use when a paper, result summary, or figure package is available"
  expected-gain: "Faster generation of Chinese research presentation decks"
  token-cost-band: "medium"
  control-category: "communication"
---
