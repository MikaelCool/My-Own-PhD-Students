...
metadata:
  category: writing
  trigger-keywords: "paper,draft,revision,abstract,introduction,related work,method,methods,results,discussion,conclusion,title,polish,nature,academic writing,manuscript,overclaim,hedging,citation,润色,论文,摘要,引言"
  applicable-stages: "16,17,19,20,22"
  priority: "1"
  version: "5.0.2-researchclaw-dc2236c"
  author: "Yuan1z skill rebuilt from course notes plus Academic Phrasebank"
  references: "https://github.com/Yuan1z0825/nature-skills/tree/main/skills/nature-polishing"
  preconditions: "Use only after experiment evidence and citation anchors are available; Preserve verified metric values exactly"
  expected-gain: "Sharper prose, fewer unsupported claims, better reviewer-facing narrative"
  token-cost-band: "low"
  control-category: "writing-governance"
---
