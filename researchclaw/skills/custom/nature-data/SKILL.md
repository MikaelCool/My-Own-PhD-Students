...
metadata:
  category: writing
  trigger-keywords: "data availability,data repository,FAIR metadata,source data,supplementary data,dataset citation,DataCite,数据可用性,数据获取声明,原始数据,源数据,数据存储库"
  applicable-stages: "16,17,19,20,22"
  priority: "2"
  version: "dc2236c-researchclaw"
  author: "Yuan1z0825/nature-skills"
  references: "https://github.com/Yuan1z0825/nature-skills/tree/main/skills/nature-data"
  preconditions: "Use when figure/source data, repository status, or data access boundaries are known"
  expected-gain: "Cleaner Nature-ready data availability and FAIR metadata statements"
  token-cost-band: "low"
