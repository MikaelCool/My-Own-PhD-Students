...
metadata:
  category: experiment
  trigger-keywords: "literature,search,citation,reference,bibliography,PubMed,CrossRef,arXiv,MeSH,systematic review,文献,检索,引用,参考文献"
  applicable-stages: "3,4,5,6,7,23"
  priority: "2"
  version: "dc2236c-researchclaw"
  author: "Yuan1z0825/nature-skills"
  references: "https://github.com/Yuan1z0825/nature-skills/tree/main/skills/nature-academic-search"
  preconditions: "Use when literature or citation retrieval tools are available; Verify current journal/source metadata before submission-critical citation decisions"
  expected-gain: "Better source routing, citation verification, and reference export discipline"
  token-cost-band: "medium"
  control-category: "evidence-quality"
---
