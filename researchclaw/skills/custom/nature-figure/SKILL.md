...
metadata:
  category: writing
  trigger-keywords: "figure,figures,plot,chart,table,caption,results,visualization,publication,nature,svg,pdf,tiff,panel,figure 1,method diagram,matplotlib,ggplot"
  applicable-stages: "14,16,17,19,20,22"
  priority: "1"
  version: "dc2236c-researchclaw"
  author: "Yuan1z0825/nature-skills"
  references: "https://github.com/Yuan1z0825/nature-skills/tree/main/skills/nature-figure"
  preconditions: "Use with verified experiment data and existing or planned figure/table artifacts"
  expected-gain: "Submission-grade figure logic, export QA, and caption discipline"
