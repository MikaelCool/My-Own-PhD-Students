...
metadata:
  category: experiment
  trigger-keywords: "paper reader,PDF,DOI,arXiv,translate,translation,figure extraction,table extraction,markdown reader,中英文对照,原文对照,全文翻译,翻译解读,读论文"
  applicable-stages: "4,5,6,7"
  priority: "3"
  version: "dc2236c-researchclaw"
  author: "Yuan1z0825/nature-skills"
  references: "https://github.com/Yuan1z0825/nature-skills/tree/main/skills/nature-reader"
  preconditions: "Use with user-provided or open-access papers and preserve source anchors"
  expected-gain: "More faithful paper reading artifacts with figure/table context"
