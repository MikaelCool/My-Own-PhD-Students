...
metadata:
  category: writing
  trigger-keywords: "write,draft,restructure,abstract,introduction,results narrative,discussion,conclusion,title,manuscript argument,Nature writing,论文写作,摘要,引言,结果,讨论,标题"
  applicable-stages: "16,17,19,20,22"
  priority: "1"
  version: "0.2.0-researchclaw-dc2236c"
  author: "Community contribution based on curated Nature/Nature Communications writing patterns and open research-writing notes"
  references: "https://github.com/Yuan1z0825/nature-skills/tree/main/skills/nature-writing"
  preconditions: "Use after core claim, evidence, and boundary are identified"
  expected-gain: "Better manuscript section architecture and claim-evidence alignment"
